...
```
6. Build the EXE + installer (runs pre-build validation by default, including help-surface validation, updates `packaging/NexGen-BBPro.iss`, and appends `release_notes.md`):
```powershell
