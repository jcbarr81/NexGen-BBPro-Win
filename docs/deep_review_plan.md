...
- **2026-07-15** — **S2-01 platoon lineups + split KPI implemented** (pending
  commit). Per `docs/specs/S2-01_platoon_lineups.md`: `utils/lineup_autofill.py`
